      ...
      >
        ...
        <div className="flex gap-2">
          <BrandButton
            type="submit"
            variant="primary"
            className="flex-1 py-3 rounded text-sm text-center font-semibold"
          >
            {t(I18nKey.ORG$NEXT)}
          </BrandButton>
          <BrandButton
            ...
            variant="secondary"
            onClick={onClose}
            className="flex-1 py-3 rounded text-sm text-center font-semibold bg-[#737373] text-white border-none"
          >
      ...
      {!isBillingHidden && (
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            <Chip testId="available-credits" variant="primary">
